...
public class FlattenBinaryTreeToLinkedListV0 {

    public static void recur(TreeNode<Integer> root) {
        if (root == null) {
            return;
        }

        TreeNode<Integer> cRoot = root;
        while(cRoot != null) {

            if (cRoot.left != null) {
                TreeNode<Integer> temp = cRoot.left;
                while(temp.right != null) {
                    temp = temp.right;
                }
                temp.right = cRoot.right;
