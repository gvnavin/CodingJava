package companies.atlassian.ratelimitv1gnavin;

import companies.atlassian.ratelimitv1gnavin.credits.CreditsCalculator;
import companies.atlassian.ratelimitv1gnavin.credits.CreditsCalculatorFactory;
...
public class FixedWindowRateLimiterImplV2 implements IRateLimiter {
    ...
    private CreditsCalculator simpleCreditsCalculator;
    ...
    public FixedWindowRateLimiterImplV2(int windowDurationInSeconds, int noOfRequestsPerWindow, int maxCreditsPerWindow) {
        ...
        simpleCreditsCalculator = CreditsCalculatorFactory.getInstance().get(windowDurationInSeconds, maxCreditsPerWindow);
    }
    ...
    public boolean ratelimit(int customerId) {
        ...
        if (isNewWindow(existingWindow, currentTimeStampInSeconds)) {
            ...
            long availableCredits = simpleCreditsCalculator.calculateCredits(existingWindow.getStartTimestamp(), currentTimeStampInSeconds);
